    ...
    <el-card>
      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="操作" width="180px">
          <template slot-scope="scope">
            <!-- 修改按钮 -->
            <el-tooltip content="编辑" placement="top" effect="dark" :enterable="false">
              <el-button
                type="success"
                icon="el-icon-edit"
                size="mini"
            ...
            <!-- 删除按钮 -->
            <el-tooltip content="删除角色" placement="top" effect="dark" :enterable="false">
              <el-button
                type="danger"
                icon="el-icon-delete"
                size="mini"
  ...
  methods: {
    ...
    async saveRoleInfo() {
      if (!this.selectedRoleId) {
        return this.$msg.error('请选择要分配的角色!')
      }
      const { data: res } = await this.$http.put(
